          ...
          <div className="px-6 pb-6 pt-12 sm:px-8 sm:pb-8">
            ...
            <ul className="mb-6 space-y-2 text-sm text-gray-700">
              ...
              <li className="flex items-start gap-2">
                ...
                <span><span className="font-semibold">Unlimited</span>  funnels, contacts & automations</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="mt-0.5 h-5 w-5 shrink-0 text-brand-green" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span><span className="font-semibold">Done</span> -with-you implementation guidance</span>
              </li>
            </ul>
