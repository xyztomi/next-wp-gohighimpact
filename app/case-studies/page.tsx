      ...
      <section className="bg-gradient-to-b from-white to-brand-green/5 px-4 py-16 sm:px-6 sm:py-24">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="mb-8 text-lg text-gray-600">
            Start your 14-day free trial of GoHighLevel CRM or schedule a consultation with our implementation team to build a custom success plan for your agency.
          </p>
